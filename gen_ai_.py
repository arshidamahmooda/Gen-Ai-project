...
st.title("🎨 Simple AI Comic Generator")
st.write("Enter a short story below and watch it turn into a 3-panel comic!")
...
if generate_btn:
    with st.spinner("🧠 Generating story panels..."):
        # ---- 1. Text generation using open model ----
    ...
    # ---- 3. Combine into comic strip ----
    st.success("✅ Comic panels generated!")
    ...
    for i, img in enumerate(images):
        ...
        caption = f"Panel {i+1}"
        draw.text((i * panel_w + 10, panel_h - 40), textwrap.fill(caption, 20), fill="black", font=font)
