...
st.title("🎨 AI Comic Creator (Generative AI Edition)")
st.markdown("Generate a short comic scene from your text prompt using real AI models!")
...
if st.button("🎬 Generate Comic"):
    st.info("⏳ Generating comic... please wait 15–30 seconds")

    # --- Generate comic storyline using GPT ---
    try:
        ...
        story_resp = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Write a 3-line funny comic about: {prompt}"}
            ]
        )
    ...
    # --- Generate Comic Image using Stable Diffusion ---
    st.subheader("🖼️ Comic Panel (Generated by Stable Diffusion)")
    try:
